            ...
            <div className='app'>
                ...
                <section>
                    ...
                    <div className='contactList'>
                        ...
                        <div className='contact' onClick={() => window.location.href = 'https://github.com/sihyeokpark'}>
                        ...
                        <div className='contact' onClick={() => window.location.href = 'https://www.instagram.com/exon001/'}>
                        ...
                        <div className='contact' onClick={() => window.location.href = 'https://discord.com/users/774607106732326922'}>
